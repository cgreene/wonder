---
name: scrub-secrets
description: Use when sanitizing a wonder profile (or similar short text) before it leaves the machine, to remove credentials and secrets — API keys, tokens, passwords, connection strings, private keys, and context-only secrets such as a named deploy password.
---
